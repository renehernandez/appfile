...
- [Contributing to Appfile](#contributing-to-appfile)
...
your Appfile binary. Please provide steps to reproduce the issue as well as the outcome you were expecting! All these details will help developers to fix any potential bugs.
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/appfile
   # Navigate to the newly cloned directory
   cd appfile
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/renehernandez/appfile
   ```
